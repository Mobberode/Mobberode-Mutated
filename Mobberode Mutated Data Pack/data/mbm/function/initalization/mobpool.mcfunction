...
data modify storage mbm.spawner entry_mobpool set value {mobs:[{wave_1:[{mob:{id:zombie,data:{spawner_tag:"mb.base.zombiespawn",entity_namespace:"minecraft:zombie",modifications:{}}}}]},{wave_2:[]},{wave_3:[{mob:{id:husk,data:{spawner_tag:"zs.huskspawn",entity_namespace:"minecraft:husk",modifications:{}}}}]},{wave_6:[{mob:{id:drowned,data:{spawner_tag:"zs.drownedspawn",entity_namespace:"minecraft:drowned",modifications:{}}}}]},{wave_9:[{mob:{id:skeleton,data:{spawner_tag:"zs.skeletonspawn",entity_namespace:"minecraft:skeleton",modifications:{}}}}]},{wave_14:[{mob:{id:wither_skeleton,data:{spawner_tag:"zs.wither.skeletonspawn",entity_namespace:"minecraft:wither_skeleton",modifications:{}}}}]}]}
...
##Revamp
data modify storage mbm.spawner entry_mobpool set value {data:[{wave:1,contents:{mob_data:[{id:zombie,spawner_tag:"mb.base.zombiespawn",entity_namespace:"minecraft:zombie",modifications:{}}]}},{wave:3,contents:{mob_data:[{id:husk,spawner_tag:"zs.huskspawn",entity_namespace:"minecraft:husk",modifications:{}}]}},{wave:6,contents:{mob_data:[{id:drowned,spawner_tag:"zs.drownedspawn",entity_namespace:"minecraft:drowned",modifications:{}}]}},{wave:9,contents:{mob_data:[{id:skeleton,spawner_tag:"zs.skeletonspawn",entity_namespace:"minecraft:skeleton",modifications:{}}]}},{wave:14,contents:{mob_data:[{id:wither_skeleton,spawner_tag:"zs.wither.skeletonspawn",entity_namespace:"minecraft:wither_skeleton",modifications:{}}]}}]}
