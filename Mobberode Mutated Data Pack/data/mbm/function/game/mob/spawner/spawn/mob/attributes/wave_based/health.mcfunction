...
##If baby. Halve
execute if predicate mbm:is_baby store result storage mbm.attributes health double 0.5 run data get storage mbm.attributes health
...
##If baby = ([Base Health]*10) /2 = [Halved Base Health] *0.1 +([Wave]*0.682) /2