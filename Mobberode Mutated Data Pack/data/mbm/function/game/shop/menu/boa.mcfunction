...
item replace entity @s enderchest.10 with knowledge_book[item_name='{"text":"Claim Wave Book","color":"aqua"}',lore=['{"text":"What will you get? It\'s a mystery that only you can find out."}','{"text":"Wave Books are randomized for everyone."}']]
...
item replace entity @s enderchest.16 with yellow_shulker_box[item_name='{"text":"Bookend","color":"yellow"}',lore=['{"text":"View or edit your architect books"}']]