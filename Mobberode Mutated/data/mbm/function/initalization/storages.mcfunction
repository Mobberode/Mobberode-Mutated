...
data modify storage mbm.spawner entry_mobpool set value {mobs:[{wave_1:[{mob:{id:zombie,data:{spawner_tag:"zs.zombiespawn",entity_namespace:"minecraft:zombie",modifications:{}}}}]},{wave_2:[]},{wave_3:[{mob:{id:skeleton,data:{spawner_tag:"zs.skeletonspawn",entity_namespace:"minecraft:skeleton",modifications:{}}}}]}]}
##For entry pool
#/data get storage minecraft:mbm.spawner entry_mobpool.mobs[{wave_1:[{}]}]
#Exit Pool (Used for kicking mobs out the active pool)

data modify storage mbm.spawner exit_mobpool set value {ids:[{wave_5:[{id:zombie}]},{wave_10:[{id:skeleton}]}]}
##For exit pool
