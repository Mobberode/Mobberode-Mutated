...
item replace entity @s inventory.13 with paper[custom_name='{"text":"Last Played Savefile | Proceed","color":"green"}',custom_data={mbm_saves.action:last_played.proceed},lore=['{"text":"Uses the last savefile you played as the host, restoring most progress","color":"white"}']]