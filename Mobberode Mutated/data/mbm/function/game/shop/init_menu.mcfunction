...
item replace entity @s enderchest.11 with bundle[item_name='{"text":"Dontate Souls to Player","color":"aqua"}',lore=['{"text":"Donate any amount to a certain someone."}'],!bundle_contents]

item replace entity @s enderchest.13 with enchanted_book[item_name='{"text":"Books of the Architect","color":"green"}',lore=['{"text":"Access and get more powerful with the Books of the Architect."}']]
