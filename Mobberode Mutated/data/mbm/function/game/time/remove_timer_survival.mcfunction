...
title @a actionbar [{"text":"Pre Wave Intermission: "},{"score":{"name":"#Hour","objective":"mbm.timer"}},{"text":":"},{"score":{"name":"#Minute","objective":"mbm.timer"}},{"text":":"},{"score":{"name":"#Second","objective":"mbm.timer"}},{"text":"."},{"score":{"name":"#Milisecond","objective":"mbm.timer"}},{"text":" "},{"score":{"name":"#VotedPlayers","objective":"mbm.votes"},"color":"blue"},{"text":"/","color":"blue"},{"score":{"name":"#Players","objective":"mbm.players"},"color":"blue"}]
